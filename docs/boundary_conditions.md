...
::: rompy_schism.boundary_core.BoundaryHandler

### BoundaryConfig

Configuration for individual boundary segments.

::: rompy_schism.boundary_core.BoundaryConfig

## Boundary Type Enums

### ElevationType

::: rompy_schism.boundary_core.ElevationType

### VelocityType

::: rompy_schism.boundary_core.VelocityType

### TracerType

::: rompy_schism.boundary_core.TracerType
...
::: rompy_schism.boundary_core.create_tidal_boundary
::: rompy_schism.boundary_core.create_hybrid_boundary
::: rompy_schism.boundary_core.create_river_boundary
::: rompy_schism.boundary_core.create_nested_boundary
...
* [Core Data](../core/data.md) - Core data handling classes
* [Core Boundary](../core/boundary.md) - Base boundary condition classes
* `rompy_schism.data.SCHISMData` - Main SCHISM configuration class
* `rompy_schism.grid.SCHISMGrid` - SCHISM grid handling
* [Hotstart](hotstart.md) - Hotstart configuration documentation