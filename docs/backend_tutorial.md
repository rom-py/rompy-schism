...
* [Boundary Conditions](boundary_conditions.md) - Comprehensive boundary conditions guide
* [Hotstart](hotstart.md) - Initial conditions configuration
* [Backend Framework](backend_framework.md) - Complete backend framework reference
* [ROMPY Backend System](../backends.md) - ROMPY backend system documentation
