...
class Sin4(NamelistBaseModel):
    ...
    alpha0: Optional[list] = Field([9.499999694526196e-3, ""], description="")
    z0max: Optional[list] = Field([0.0, ""], description="")
    betamax: Optional[list] = Field([1.54, ""], description="")
    sinthp: Optional[list] = Field([2.0, ""], description="")
    zalp: Optional[list] = Field([6.000000052154064e-3, ""], description="")
    ...
    swellf2: Optional[list] = Field([-1.799999922513962e-2, ""], description="")
    swellf3: Optional[list] = Field([2.199999988079071e-2, ""], description="")
    swellf4: Optional[list] = Field([150000.0, ""], description="")
    swellf5: Optional[list] = Field([1.20000004768372, ""], description="")
    swellf6: Optional[list] = Field([0.0, ""], description="")
    swellf7: Optional[list] = Field([360000.0, ""], description="")
    z0rat: Optional[list] = Field([3.999999910593033e-2, ""], description="")
    sinbr: Optional[float] = Field(0.0, description="")


class Sds4(NamelistBaseModel):
    sdsc1: Optional[list] = Field([0.0, ""], description="")
    fxpm3: Optional[list] = Field([4.0, ""], description="")
    fxfm3: Optional[list] = Field([2.5, ""], description="")
    fxfmage: Optional[list] = Field([0.0, ""], description="")
    sdsc2: Optional[list] = Field([-2.200000017182902e-5, ""], description="")
    sdscum: Optional[list] = Field([-0.403439998626709, ""], description="")
    sdsstrain: Optional[list] = Field([0.0, ""], description="")
    sdsc4: Optional[list] = Field([1.0, ""], description="")
    sdsc5: Optional[list] = Field([0.0, ""], description="")
    sdsc6: Optional[list] = Field([0.300000011920929, ""], description="")
    sdsbr: Optional[list] = Field([8.999999845400453e-4, ""], description="")
    ...
    sdsbck: Optional[list] = Field([0.0, ""], description="")
    ...
    sdsbrfdf: Optional[list] = Field([0.0, ""], description="")
    sdsbm0: Optional[list] = Field([1.0, ""], description="")
    sdsbm1: Optional[list] = Field([0.0, ""], description="")
    sdsbm2: Optional[list] = Field([0.0, ""], description="")
    sdsbm3: Optional[list] = Field([0.0, ""], description="")
    sdsbm4: Optional[list] = Field([0.0, ""], description="")
    sdshfgen: Optional[list] = Field([0.0, ""], description="")
    sdslfgen: Optional[list] = Field([0.0, ""], description="")
    whitecapwidth: Optional[list] = Field([0.300000011920929, ""], description="")
    fxincut: Optional[list] = Field([0.0, ""], description="")
