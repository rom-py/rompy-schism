...
def test_tidal_only_boundary_format(sample_grid, tidal_dataset, tmp_path):
...
def test_hybrid_boundary_format(sample_grid, tidal_dataset, tmp_path):
...
def test_river_boundary_format(sample_grid, tmp_path):
    ...
    with open(bctides_path, "w") as f:
        ...
        num_nodes = sample_grid.nobn[0]  # Number of nodes in first boundary
...
def test_nested_boundary_format(sample_grid, tmp_path):
...
def test_flather_boundary_format(sample_grid, tmp_path):
...
def test_multi_segment_boundary_format(sample_grid, tidal_dataset, tmp_path):
...
def test_bctides_nbfr_format(sample_grid, tidal_dataset, tmp_path):
