...
def test_hybrid_factory(tidal_data_files, grid2d, time_range, temp_output_dir):
    ...
    if not os.path.exists(tidal_data_files["elevation"]) or not os.path.exists(tidal_data_files["velocity"]):
...
def test_integration_with_schism_data(grid2d, time_range, temp_output_dir, tidal_dataset):
