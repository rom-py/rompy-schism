...
class SCHISMNameListConfig(BaseModel):
    ...
    physical_params: dict = Field(default_factory=dict, description="Physical parameters")
    numerical_params: dict = Field(default_factory=dict, description="Numerical parameters")
