...
class TestTidalBoundaryIntegration:
    ...
    def test_tidal_boundary_write_bctides(self, grid_path, sample_grid, tidal_dataset, tmp_path):
    ...
    def test_schism_data_tides_enhanced(self, grid_path, sample_grid, tidal_dataset, time_range, tmp_path):
    ...
    def test_schism_config_with_enhanced_tides(self, grid_path, sample_grid, tidal_dataset, time_range, tmp_path):
    ...
    def test_multiple_boundary_types(self, grid_path, sample_grid, tidal_dataset, time_range, tmp_path):
        ...
        # Create a TidalBoundary directly for testing
        from rompy.schism.boundary_tides import TidalBoundary, ElevationType, VelocityType
        boundary = TidalBoundary(
            grid_path=grid_path,
            constituents=["M2", "S2", "N2"],
            tidal_elevations=tidal_dataset.elevations,
