...
class TestTidalBoundary:
    ...
    def test_get_flags_list(self, sample_grid_path):
        ...
        boundary.set_boundary_type(1, ElevationType.CONSTANT, VelocityType.CONSTANT, 
                                 vthconst=-100.0, ethconst=1.0)
        ...
        assert flags[1] == [int(ElevationType.CONSTANT), int(VelocityType.CONSTANT), 0, 0]
